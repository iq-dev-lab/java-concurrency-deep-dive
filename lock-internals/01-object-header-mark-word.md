...
**[⬅️ 이전: Ch2 Double-Checked Locking](../java-memory-model/06-double-checked-locking.md)** | **[홈으로 🏠](../README.md)** | **[다음: synchronized 락 확장 ➡️](./02-synchronized-lock-escalation.md)**
