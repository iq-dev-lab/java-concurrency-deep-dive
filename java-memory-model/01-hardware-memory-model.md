...
**[⬅️ 이전: Ch1 데몬 스레드와 JVM 종료](../os-threads-and-java-threads/05-daemon-thread-jvm-shutdown.md)** | **[홈으로 🏠](../README.md)** | **[다음: JMM — 주 메모리와 작업 메모리 ➡️](./02-jmm-main-working-memory.md)**
